...
- Name: automation-test-playwright\tests\e2e\payment\customer-invoice-payment.e2e.spec.ts >> Customer Invoice Payment E2E @regression >> [E2E-CUS-PAY-002] customer can move from payment modal to QR payment page
- Location: automation-test-playwright\tests\e2e\payment\customer-invoice-payment.e2e.spec.ts:85:7
