...
test.describe("Staff - API Profile @regression", () => {
  ...
  test("[STF-PRO-003] - API Staff Profile - Username - Invalid OTP Rejection", async () => {
    ...
    expectLooseApiText(errorBody.message, /otp|ma|xac thuc|khong tim thay|het han/i);
  ...
  test("[STF-PRO-008] - API Staff Profile - Password - Minimum Length Validation", async () => {
    ...
    expectLooseApiText(errorBody.message, /short|ngan|it nhat|min|ky tu/i);
