...
export const adminEndpointCatalog: RequestDescriptor[] = [
  ...
  { id: "ADM-BAI-001", method: "GET", path: `/api/v1/admin/building-additional-information/legal-authorities/${missingId}` },
  ...
  { id: "ADM-BAI-005", method: "GET", path: `/api/v1/admin/building-additional-information/nearby-amenities/${missingId}` },
  ...
  { id: "ADM-BAI-009", method: "GET", path: `/api/v1/admin/building-additional-information/suppliers/${missingId}` },
  ...
  { id: "ADM-BAI-013", method: "GET", path: `/api/v1/admin/building-additional-information/planning-maps/${missingId}` },
  ...
  { id: "ADM-STF-006", method: "GET", path: `/api/v1/admin/staff/${missingId}/assignments/customers` },
  { id: "ADM-STF-007", method: "PUT", path: `/api/v1/admin/staff/${missingId}/assignments/customers`, data: [missingId] },
  { id: "ADM-STF-008", method: "GET", path: "/api/v1/admin/staff/buildings" },
  { id: "ADM-STF-009", method: "GET", path: `/api/v1/admin/staff/${missingId}/assignments/buildings` },
  { id: "ADM-STF-010", method: "PUT", path: `/api/v1/admin/staff/${missingId}/assignments/buildings`, data: [missingId] },
  { id: "ADM-STF-011", method: "POST", path: `/api/v1/admin/staff/${missingId}/quick-assign`, params: { buildingId: missingId, customerId: missingId } },

  { id: "ADM-PRQ-001", method: "GET", path: "/api/v1/admin/property-requests", params: { page: 1, size: 5 } },
  { id: "ADM-PRQ-002", method: "GET", path: `/api/v1/admin/property-requests/${missingId}` },
  ...
  { id: "ADM-PRQ-005", method: "GET", path: `/api/v1/admin/property-requests/${missingId}/contract-data` },
  { id: "ADM-PRQ-006", method: "GET", path: `/api/v1/admin/property-requests/${missingId}/sale-contract-data` },
